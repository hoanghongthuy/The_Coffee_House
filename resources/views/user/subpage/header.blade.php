                    ...
                    <div class="header__top__inner">
                        ...
                        <div class="header__top__right">
                            <div class="header__top__right__links">
                                <a href="#" class="search-switch"><img src="{{url('Coffee')}}/images/icon/search.png" alt=""></a>
                                <a href="#"><img src="{{url('Coffee')}}/images/icon/heart.png" alt=""></a>
                            </div>
                            <div class="header__top__right__cart">
                                <a href="#"><img src="{{url('Coffee')}}/images/icon/cart.png" alt=""> <span>0</span></a>
                                <div class="cart__price">Cart: <span>$0.00</span></div>
                            </div>
                        </div>
                    </div>
