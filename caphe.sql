...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 18, 2020 lúc 07:04 PM
...
(68, 1, 'Cà Phê Sữa Trứng Muối', 'ca-phe-sua-trung-muoi', 55000, 0, '1 phiên bản cà phê đặc biệt, được kết hợp bởi 1 shot espresso đượm vị, kết hợp với lớp sữa tươi và foam trứng muối mặn nhẹ, beo béo - cho cảm giác \"phê\" đúng nghĩa, tỉnh táo đầy mới lạ.', 'caphe_sua_trungmuoi.jpg', 0, 0, 1, 0, 0),
(69, 5, 'Trà Sữa Khoai Môn', 'tra-sua-khoai-mon', 42000, 0, 'Vị khoai môn thơm ngon quyện cùng nền trà lài hảo hạng - tạo nên ly Trà sữa \"huyền thoại\" ngọt bùi đầy cân bằng. Có sẵn \"khoai môn thiệt\" mềm mềm cho từng ngụm thiệt đã.', 'tra_sua_khoaimon.jpg', 0, 0, 1, 0, 0),
(70, 4, 'Trà Lài Sen Trứng Muối', 'tra-lai-sen-trung-muoi', 45000, 0, 'Nghe vô lý nhưng lại ngon thuyết phục. Nền trà hảo hạng cùng hạt sen và lớp foam trứng muối beo béo - cho hương vị tươi mát, ngon bất ngờ chỉ từ ngụm đầu tiên.', 'tra_sen_trung_muoi.jpg', 0, 0, 1, 0, 0);
